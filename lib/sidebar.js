...
var Sidebar = Trait.compose(
    ...
    _render: function() {
         ...
         *                    style="min-width:18em;width:22em;max-width:100em;"
        ...
        if (self.options.exclude.indexOf('splitter') < 0)
        {
            ...
            {
                var gripContainer   = xul('hbox'),
                    spacer          = xul('spacer');
                gripContainer.setAttribute('id', id +'-grip-container');

                spacer.setAttribute('flex', 1);
                gripContainer.appendChild(spacer);
                ...
                gripContainer.appendChild(self.sbGrippy);

                self.sbSplitter.appendChild( gripContainer );
